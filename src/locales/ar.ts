...
export const ar: LocaleDict = {
  meta: {
    title: "SmartApe — تابع أذكى الأموال على سولانا",
    description:
      "متعقّب الأموال الذكية لعملات الميم على شبكة سولانا. نقيّم المحافظ الرابحة ونصنّفها (ذكي / قنّاص / مطّلع / مؤثّر) ونرسل تنبيهات تيليجرام فورية بلغتك.",
  },
  nav: {
    links: {
      features: "المزايا",
  ...
  hero: {
    ...
    sub: "يقيّم SmartApe المحافظ الرابحة على السلسلة وينبّهك لحظة شرائها — مصنّفة، ومدمجة بفحص مكافحة الاحتيال، وتصلك مباشرة عبر تيليجرام بلغتك.",
